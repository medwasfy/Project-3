...
(function () {
  var MainController = function MainController($http, $scope, $timeout, socket, Catalog, Product) {
    var _this = this;
  ...
  angular.module('buildoutletApp').controller('MainController', MainController);
})();
