...
angular.module('buildoutletApp').controller('ManageProductsCtrl', ['$scope', 'Product', 'Modal', function ($scope, Product, Modal) {
...
}]).controller('ManageProductsEditCtrl', ['$scope', '$stateParams', '$state', 'Upload', 'categories', 'product', 'Product', function ($scope, $stateParams, $state, Upload, categories, product, Product) {
