...
angular.module('buildoutletApp').controller('ManageCategoriesCtrl', ['$scope', 'Catalog', 'Modal', function ($scope, Catalog, Modal) {
...
}]).controller('ManageCategoriesEditCtrl', ['$scope', '$state', 'Catalog', '$stateParams', function ($scope, $state, Catalog, $stateParams) {
...
}]).controller('ManageCategoriesAddCtrl', ['$scope', '$state', 'Catalog', '$stateParams', function ($scope, $state, Catalog, $stateParams) {
...
//# sourceMappingURL=manage-categories.controller.js.map
