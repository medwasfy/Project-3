...
angular.module('buildoutletApp', ['buildoutletApp.auth', 'buildoutletApp.admin', 'buildoutletApp.constants', 'ngCart', 'ngCookies', 'ngResource', 'ngSanitize', 'btford.socket-io', 'ui.router', 'validation.match', 'ui.bootstrap', 'ngFileUpload']).config(function ($urlRouterProvider, $locationProvider) {
